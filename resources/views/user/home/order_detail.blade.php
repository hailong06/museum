<div class="container">
    <h1>Details</h1>
    <h6 style="color: red">*Please check your information before payment</h6>
    <br>
        ...
        <div class="col-lg-6">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="radio" required name="vnp"> VNPay
                ...
                <div class="col-lg-4 offset-lg-8">
                    <div class="proceed-checkout">
                        <ul>
                            ...
                            <h5>Discount:</h5>
                            <li id="discount" value="0">0</li>
                        </ul>
                        <ul>
                            <h4>Total: </h4>
                            <li id="total">{{ number_format(array_sum($total)) }}</li>
                            <li id="actual-total"></li>
                        </ul>
